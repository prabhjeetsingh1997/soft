<?php
    ...
    $arrQuery=$objAdmin->getALLDskLeads();
        ...
        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
              ...
              <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">
                  <li><a tabindex="-1" href="#" onclick="photoReceived();">Photo Received</a></li> <li class="divider"></li>               
  ...
  <div class="modal-dialog">
    ...
    function Move() {
        ...
        if (moveto == 'photo_received') {
            $.ajax({
              type:'post',
              url: '_ajax_dsk_lead_massaction.php?action=move_leads_to_photo',
              data:{leadid:id},
              success:function(result) {
              if(result == '1')
              {
    ...
    function Export() {
      var conf = confirm("Export Leads to CSV?");
        if(conf == true)
        {
          window.open("exportleads.php?action=exportleads", '_blank');
        }
    }
