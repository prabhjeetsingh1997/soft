	...
	<div id="rates_<?php echo $count; ?>" class="rateRow">
		...
		<div class="col-md-2">
			<div class="form-group">
				...
				<button type="button" class="btn btn-primary btn-sm showRtable" rel="<?php echo $count;?>">Show/Hide Table</button>
			</div>
		</div>
		<!--<div class="col-md-2 text-right"> <div class="form-group" style="margin: 28px 0 10px;"><label for="last">Remove</label>  <a class="delete" rel="'+count+'" href="javascript:void(0)" onclick="remove_rate(<?php echo $count; ?>,0)"><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a></div></div>-->
			...
			<table class="table">
				...
				<tbody border="1px">
					...
					<?php
						...
						$roomCount8=1;
					?>
						<td class="dinnerCol">Dinner <input type="hidden" name="roomName_<?php echo $count; ?>_8_<?php echo $roomCount8;?>" value="<?php echo $dinnRoomId;?>"><input type="hidden" name="room_name_<?php echo $count; ?>_8_<?php echo $roomCount8;?>" id="room_name_1_8_<?php echo $roomCount8;?>" value="Dinner"/></td>
					<?php
					...
					<tr>
						...
						<a href="javascript:void(0);" class="add_more_row" relTbl="<?php echo $count; ?>" title="Add field" style="width:98px;" ><img src="add-icon.png" style="width:28px;"/></a></td>
						<td></td>
					</tr>
					<tr>
						<td colspan="15">
							<div class="col-md-12 text-right"> <div class="form-group" style="margin: 28px 0 10px;"><label for="last">Remove Table</label>  <a class="delete" rel="'+count+'" href="javascript:void(0)" onclick="remove_rate(<?php echo $count; ?>,0)"><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a></div></div>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<!--<div class="col-md-1"> <div class="form-group"><label for="last">Remove</label>  <a class="delete" rel="'+count+'" href="javascript:void(0)" onclick="remove_rate(<?php echo $count; ?>,0)"><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a></div></div>-->	
	</div>
	<?php	
}
