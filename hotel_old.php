						...
						<div class="box-body">
							<div class="row">
								...
								<input type="hidden" name="hotelRoomSerDetail[]" value="<?php echo @$val['id']?>"/>
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="file" class="form-control roomPics" name="Pics[]" id="Pics_<?php echo $countDiv;?>" rel="1" placeholder="Pics" value=""/>
										</div>
									</div>
								</div>
								<?php
								...
								<div class="col-md-2">
									<div class="form-group">
										<!--<label for="Pics">Pics</label>-->
										<input type="file" class="form-control roomPics" name="Pics[]" id="Pics_1" rel="1" placeholder="Pics" value="" multiple="true"/>
									...
									<div class="bootstrap-timepicker">
										<div class="form-group">
										  <div class="input-group">
											<input type="text" name="checkInTime" id="checkInTime" class="form-control timepicker htimepicker" value="<?php if(!isset($checkin_time)){echo '12:00 PM'; }else{echo $checkin_time;} ?>"/>
							...
							<div class="col-md-2">
								...
								<div class="col-md-10">
									...
									<div class="bootstrap-timepicker">
										<div class="form-group">
										  <div class="input-group">
											<input type="text" name="checkOutTime" id="checkOutTime" class="form-control timepicker htimepicker" value="<?php if(!isset($checkout_time)){echo '10:00 AM'; }else{echo $checkout_time;} ?>"/>
											<div class="input-group-addon">
											  <i class="fa fa-clock-o"></i>
											</div>
										  </div><!-- /.input group-->
						...
						<div class="box-body">
							<div class="row">
								<div class="myattch">
									<div id="attch_1">
										<div style="clear:both;"></div>
										<input type="hidden" name="attachEdId[]" id="panCardId" value="<?php echo $docsStaticArr[0]['id'];?>"/>
										<div class="col-md-2">
											<div class="form-group">
										...
										<div class="col-md-10">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="file" class="form-control" name="file_upload[]" id="hotel_pan_card_copy"  value=""/>
													<input type="hidden" name="upldFileName[]" id="panCardDoc" class="Uplddoc_1" value="<?php echo $docsStaticArr[0]['doc'];?>" />
												</div>
											</div>
											<div class="col-md-5">
												<div id="panCardDocName"><span id="attdoc_1"><?php echo $docsStaticArr[0]['doc'];?></span>
												<div id="panDocs"></div>
												</div>
											</div>
											<?php if($docsStaticArr[0]['doc'] != ''){?>
											<div class="col-md-2">
												<div class="form-group">
													<a class="delete" relId="<?php echo @$docsStaticArr[0]['id'];?>" rel="<?php echo $docsStaticArr[0]['id'];?>" href="javascript:void(0)" onclick="remove_attach(1,'<?php echo @$docsStaticArr[0]['id'];?>','static')"><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a>
												</div> 
											</div>
											<?php } ?>
										</div><!-- /.form-group -->
									...
									<div id="attch_2">
										<div style="clear:both;"></div>
										<input type="hidden" name="attachEdId[]" id="photoId" value="<?php echo $docsStaticArr[1]['id'];?>"/>
										<div class="col-md-2">
											<div class="form-group">
										...
										<div class="col-md-10">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="file" class="form-control" name="file_upload[]" id="hote_photo_copy"  value=""/>
													<input type="hidden" name="upldFileName[]" id="photoDoc" class="Uplddoc_2" value="<?php echo $docsStaticArr[1]['doc'];?>" />
												</div>
											</div>
											<div class="col-md-5">
												<div id="photoDocName"><span id="attdoc_2"><?php echo $docsStaticArr[1]['doc'];?></span>
												<div id="photoDocs"></div>
												</div>
											</div>
											<?php if($docsStaticArr[1]['doc'] != ''){?>
											<div class="col-md-2">
												<div class="form-group">
													<a class="delete" relId="<?php echo @$docsStaticArr[1]['id'];?>" rel="<?php echo $docsStaticArr[1]['id'];?>" href="javascript:void(0)" onclick="remove_attach(2,'<?php echo @$docsStaticArr[1]['id'];?>','static')"><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a>
												</div> 
											</div>
											<?php } ?>
										</div><!-- /.form-group -->
									...
									<div id="attch_3">
										<div style="clear:both;"></div>
										<input type="hidden" name="attachEdId[]" id="addrProofId" value="<?php echo $docsStaticArr[2]['id'];?>"/>
										<div class="col-md-2">
											<div class="form-group">
										...
										<div class="col-md-10">
											...
											<div class="form-group">
												...
												<input type="file" class="form-control" name="file_upload[]" id="hotel_Contract_copy"  value=""/>
												<input type="hidden" name="upldFileName[]" id="contCopyDoc" class="Uplddoc_3" value="<?php echo $docsStaticArr[2]['doc'];?>" />
											</div>
											</div>
											<div class="col-md-5">
											<div id="contCopyDocName"><span id="attdoc_3"><?php echo $docsStaticArr[2]['doc'];?></span>
												<div id="contactDocs"></div>
											</div>
											</div>
											<?php if($docsStaticArr[2]['doc'] != ''){?>
											<div class="col-md-2">
												<div class="form-group">
													<a class="delete" relId="<?php echo @$docsStaticArr[2]['id'];?>" rel="<?php echo $docsStaticArr[2]['id'];?>" href="javascript:void(0)" onclick="remove_attach(3,'<?php echo @$docsStaticArr[2]['id'];?>','static')"><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a>
												</div> 
											</div>
											<?php } ?>
										</div><!-- /.form-group -->
									...
									<div id="attch_<?php echo $countAttach;?>">
										...
										<div class="col-md-8">
											<div class="col-md-5">
											<div class="form-group">
												<input class="file_upload" id="add_more_file_<?php echo $countAttach;?>" name="file_upload[]" type="file" multiple>
									...
									<div class="col-md-2">
										...
										<?php
											...
											if(count($photosData))
											{
												...
												$pics .= '<div class="col-md-3 hpBox" id="hpicsmain_'.$name.'"><img alt="Hotel Image" class="superbox-img" src="document/hotel_doc/hotel_pics/'.$photos.'" id="hpic_'.$name.'" rel="'.$name.'" style="width:81%;height:85px;margin:10px;padding: 10px"><img class="delHotelImg" id="p_'.$name.'" src="document/hotel_doc/hotel_room_pic/x.png" relid="'.$name.'" alt="delete"><input type="text" name="hImage[]" value="'.$caption.'" placeholder="Image Caption" style="width: 100%;"></div>';	
		...
		<div class="" >	
			<div class="rate">
				...
				<div id="rates_<?php echo $j;?>" class="<?php echo $rClass; ?>">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" class="form-control fromdate" name="fromdate_<?php echo $j;?>" id="fromdate" placeholder="Name" value="<?php echo date('j M Y',strtotime($date_rates_detail[$j-1]['from_date'])); ?>"/>
						</div>						
					</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" class="form-control todate" name="todate_<?php echo $j;?>" id="todate" placeholder="Name" value="<?php echo date('j M Y',strtotime($date_rates_detail[$j-1]['to_date'])); ?>"/>
						</div>						
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label for="search">Meal Plan</label>
							<select class="form-control" name="mealPlan_<?php echo $j; ?>">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<button type="button" class="btn btn-primary btn-sm showRtable" rel="<?php echo $j;?>">Show/Hide Table</button>
						</div>
					</div>
					<?php
					if($item > 1){
						...
						<table class="table">
							...
							<tbody border="1px">
								...
								?>
									...
									<input type="text" name="roomType_<?php echo $j;?>_<?php echo $extraCount; ?>_1" value="<?php echo $EroomName; ?>" onblur="add_room_name(<?php echo $extraCount; ?>,$(this).val(),1)"><input type="hidden" name="roomName_<?php echo $j;?>_<?php echo $extraCount; ?>_1" value="<?php echo $extraCount; ?>"><input type="hidden" name="room_name_<?php echo $j;?>_<?php echo $extraCount; ?>_1" id="room_name_<?php echo $j;?>_<?php echo $extraCount; ?>_1" value="<?php echo $EroomName; ?>"></td>
								...
								<tr>
									...
									<a href="javascript:void(0);" class="add_more_row" id="add_more_row" relTbl="<?php echo $countDateRates; ?>" title="Add field" style="width:98px;" ><img src="add-icon.png" style="width:28px;"/></a></td>
									<td></td>
								</tr>
								<?php
								if($item > 1){
				...
				<?php
					...
					{
					?>
						<!--<div class="col-md-1"> <div class="form-group"><label for="last">Remove</label>  <a class="delete" rel="<?php echo $item; ?>" href="javascript:void(0)" onclick="remove_rate(<?php echo $item; ?>,<?php echo $dateId; ?>)"><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a></div></div>-->
					<?php	
						}
					$item++;	
						}	
				...
				?>
				<div id="rates_1">
					<input type="hidden" id="tbl_1_item_count10" name="tbl_1_item_count10" value="8">
					<div class="col-md-2">
						<div class="form-group">
							<h4  class="box-title"><b style="font-size: 17px;">	Rate </b></h4>
						</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label for="search">From:Calender</label>
							<input type="text" class="form-control fromdate" name="fromdate_1" id="fromdate" placeholder="Name" value="<?php echo date('d F Y');?>"/>
						</div>						
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label for="search">To:Calender</label>
							<input type="text" class="form-control todate" name="todate_1" id="todate" placeholder="Name" value="<?php echo date('d F Y');?>"/>
						</div>						
					</div>
					<div class="col-md-3">
						<div class="form-group">
						...
						<table class="table">
							...
							<tbody border="1px">
								...
								<tr>
									...
									<a href="javascript:void(0);" class="add_more_row" id="add_more_row" relTbl="1" title="Add field" style="width:98px;" ><img src="add-icon.png" style="width:28px;"/></a></td>
									<td></td>
								</tr>
							</tbody>
						</table>
			...
			$('#hote_photos').uploadify({
				...
				'onUploadSuccess': function (file, data, response) {
					 ...
					 var a=$.parseJSON(data);
						...
						//$("#bioData").val(imgName);
						/* var already = $("#hUplodedPhotos").val();
						var newFile = already+','+imgName;
						$("#hUplodedPhotos").val(newFile); */
...
$(document).on('click','#add_more_rate',function(){
			...
			$(document).on('click','.add_more_row',function(){
				...
				$(prev).find('.dinnerCol').html('<input type="text" name="roomType_'+ttlTbl+'_'+count+'_1" value="" onblur="add_room_name('+count+',$(this).val(),'+ttlTbl+')" /><input type="hidden" name="roomName_'+ttlTbl+'_'+count+'_1" value="0"><input type="hidden" name="room_name_'+ttlTbl+'_'+count+'_1" id="room_name_'+ttlTbl+'_'+count+'_1" value=""/>');
				for(i=2;i<ttlroom;i++){
					var roomtype='roomType_'+ttlTbl+'_'+count+'_'+i;
					$(prev).find('.roomType_'+ttlTbl+'_'+i).attr({id:roomtype,name:roomtype});
					var roomtypeId='roomTypeId_'+ttlTbl+'_'+count+'_'+i;
					$(prev).find('.roomTypeId_'+ttlTbl+'_'+i).attr({id:roomtypeId,name:roomtypeId});
					var hotelRateId='hotelRateId_'+ttlTbl+'_'+count+'_'+i;
					$(prev).find('.hotelRateId_'+ttlTbl+'_'+i).attr({id:hotelRateId,name:hotelRateId,value:0});
				}
				$(prev).find('.delRow').remove();
				$(prev).find('.dinnerCol').parent().append('<td class="delRow"><a class="delete_row" rel="'+count+'"  href="javascript:void(0)" ><i class="fa fa-fw fa-times-circle-o" style="color:red;"></i></a></td>');
				...
				$("#item_count").val(count);
				$("#tbl_"+ttlTbl+"_item_count10").val(count);
			...
			function remove_attach(counter,relId, type)
			{
				...
				if(relId == 0){
					...
					if(confirm("Do you want to delete?")){
						$.ajax({
							type:"POST",
							url:"_ajax_hotel_prsnl_detail.php?action=delAttach",
							data:{attachId:relId},
