...
function CheckAuthentication()
{
    ...
    return isset($_SESSION['IsAuthorized']) && $_SESSION['IsAuthorized'];
     //return isset($_SESSION['CKFinder_UserRole']) && $_SESSION['CKFinder_UserRole'];
...
//for website
$baseUrl = 'http://firstdmc.com/ckeditor_4.4.5_full/ckeditor_images/';
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/ckeditor_4.4.5_full/ckeditor_images/';
