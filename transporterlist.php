<?php 
	...
	{
		$id=$_GET['id'];
		$objtransporter->deleteTransporterById($id);
		header("location:transporterlist.php");
	}  
	$arrTransporter=$objtransporter->getAllTransporter();
               ...
               <!--  <div class="box-header">
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php 
					$count=1;
					foreach($arrTransporter as $key=>$val)
					{
						?>
                      <tr>
                        <td><?php echo $count++;?></td>
                        <td><?php echo $val['hotal_name'];?></td>
                        <td><?php echo $val['transporter_user_id'];?></td>
						...
						<td>
							<div class="btn-group btn-group-xs">
								<a href="transporter.php?action=edit&id=<?php echo $val['id'];?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
