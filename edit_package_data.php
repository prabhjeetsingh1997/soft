...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>View Tour Card Package Details</h1>
	</section>
			...
			<div class="box-body">	
				...
				<div id="searchData" style="padding:15px 0;">
					<div style="border: 1px solid #DDD;padding: 10px;border-radius: 5px;float: left;width: 100%; margin-bottom:10px;">
						...
						<div class="col-md-4">
							<button type="button" class="btn btn-primary btn-lg" onclick="calc_prices()" id="calculated_prices" style="margin-top:53px;">Calculate Pric</button>
						</div>
