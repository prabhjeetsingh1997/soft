<?php 
	...
	$arrQuery=$objAdmin->getAllTourcard($start_from,$record_per_page);
          ...
          <div class="row">
            <div class="col-xs-12">
               ...
               <!--  <div class="box-header">
					...
					?>
                      <tr>
						...
						<td>
							<div class="btn-group btn-group-xs">
								<?php 
								if($val['queryType']=='Package')
								{
								?>
								<a href="edit_package_tour_card.php?action=edit&id=<?php echo $val['id'];?>&queryType=<?php echo $val['queryType'] ?>" class="btn btn-info" title="Edit" data-toggle="tooltip"><i class="fa fa-edit"></i></a>
								...
								{
								?>
								<a href="edit_hotel_tour_card.php?action=edit&id=<?php echo $val['id'];?>&queryType=<?php echo $val['queryType'] ?>" class="btn btn-info" title="Edit" data-toggle="tooltip"><i class="fa fa-edit"></i></a>
								<?php 
								}
								?>
    			...
    			<br />
    		<?php
			    $page_result=$objAdmin->getAlltourcardResult();
			   ...
			   $total_pages = ceil($total_records/$record_per_page);
			    ...
			    if($page > 1)
			    {
			     ...
			     echo "<li class='queryPage'><a href='tour_card.php?page=1'>First</a></li>";
			     echo "<li class='queryPage'><a href='tour_card.php?page=".($page - 1)."'><<</a></li>";
			    }
			    for($i=$start_loop; $i<=$end_loop; $i++)
			    {
			     ...
			     echo "<li class='queryPage ".$class."'><a href='tour_card.php?page=".$i."'>".$i."</a></li>";
			    }
			    if($page <= $end_loop)
			    {
			     echo "<li class='queryPage'><a href='tour_card.php?page=".($page + 1)."'>>></a></li>";
			     echo "<li class='queryPage'><a href='tour_card.php?page=".$total_pages."'>Last</a></li>";
			    }
			    echo "</ul>";
	...
	$("#perpage").change(function() {
		...
		$.ajax({
			...
			success:function(result) {
				if(result === '1')
				{
					window.location.href='tour_card.php';
